...
namespace WeixinPrinter
{
    ...
    public partial class HomeForm : Form
    {
        ...
        //重置打印码
        private void ResetPrintCode()
        {

            wxPrinter.resetPrintCode();
            //显示打印码
            rPrintCodeLabel.Text = wxPrinter.getPrintCode();
        }
        ...
        private void rPrintCodeLabel_Click(object sender, EventArgs e)
        {
            ResetPrintCode();
        }
